...
export const menuItems: (MenuItem & { sortOrder?: number })[] = [
  ...
  sabaMenuItem("special-plateau-lamb-shank", "special-plateau", "Special Plateau with Lamb Shank", 4299, "(serves 2 - 3) (Comes with 3 portions of either rice/pasta, 1 portion of Lamb Shank, 1 portion salmon, with small portion of beef suqaar and chicken suqaar)", 49),
  ...
  sabaMenuItem("bigger-plateau-lamb-shank", "special-plateau", "Bigger Plateau with Lamb Shank", 7299, "(serves 4 - 5) (Comes with 5 portions of either rice/pasta, 2 portions of Lamb Shank and 1 portion salmon, with generous portion of beef suqaar and chicken suqaar)", 51),
  sabaMenuItem("bigger-plateau-saba-lamb", "special-plateau", "Bigger Plateau with Saba Lamb", 6499, "(serves 4 - 5) (Comes with 5 portions of either rice/pasta, 2 portions of Saba Lamb and 1 portion salmon, with generous portion of beef suqaar and chicken suqaar)", 52),
